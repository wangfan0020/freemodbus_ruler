...
typedef struct{
rt_uint8_t *ucSDiscInBuf;
rt_uint16_t DiscInSize;
rt_uint8_t *ucSCoilBuf;
rt_uint16_t CoilSize;
rt_uint16_t *usSRegInBuf;
rt_uint16_t RegInSize;
rt_uint16_t *usSRegHoldBuf;
rt_uint16_t RegHoldSize;
}eMBFuncCofg;
